...
use crate::compiler::{
    ...
    ssa::{
        ...
        hlssa::{CallTarget, CastTarget, HLFunction, OpCode, Radix, SliceOpDir, Type, TypeExpr},
        traits::Instruction,
    },
...
/// `purify_witness_slices` reads that taint to split such slices into `(physical, log_len)`
/// tuples).
///
