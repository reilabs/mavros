...
use crate::{
    ...
    compiler::{
        ...
        passes::{
            ...
            lower_witness_integer_arith_ops::LowerWitnessIntegerArithOps,
            lower_witness_integer_casts_and_shifts::LowerWitnessIntegerCastsAndShifts,
    ...
    pub fn explictize_witness(&mut self) -> Result<(), Error> {
        let mut pass_manager = PassManager::new(
            ...
            vec![
                ...
                Box::new(CSE::new()),
                Box::new(DCE::new(dead_code_elimination::Config::pre_r1c())),
                Box::new(LowerWitnessIntegerCastsAndShifts::new()),
                Box::new(Simplifier::new()),
                Box::new(CSE::new()),
                Box::new(DCE::new(dead_code_elimination::Config::pre_r1c())),
