    ...
    pub fn make_struct_access_static(&mut self) -> Result<(), Error> {
        let mut pass_manager = PassManager::<Empty>::new(
            ...
            vec![
                ...
                Box::new(WitnessUnconstrainedReturns::new()),
